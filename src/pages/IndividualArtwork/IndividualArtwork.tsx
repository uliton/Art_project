  ...
  return (
    <div className="artwork-container">
        ...
        <div className="images">
          <div className="titleAndAuthor mobile-only">
            <div className="nameInfo">
              ...
              <p>
                By{" "}
                <a className="nameInfo__authorLink" href={authorLink}>
                  {authorName}
                </a>
              </p>
            </div>
            <div className="buttonsContainer">
              <div onClick={handleActivateLike} className="likeContainer">
                <svg
                  className={classNames(isLike && "active")}
          ...
          <div className="images__image-container">
            <div className="images__image">
              <img
                src="https://ik.imagekit.io/theartling/prod/tr:cm-pad_resize,w-1094,h-1094/products/Product/aa06e0846fdd4928b2ffeaee51683a3f.jpg"
                alt="Artwork"
              />
            </div>
          </div>
      ...
      <div className="support-information">
        <hr className="artwork-container__space" />
        <div className="support-information__title">Buy With Confidence</div>
      ...
      <div className="section">
        <div className="section__title">Artist Statement</div>
      ...
      <hr className="artwork-container__space" />
      <div className="section">
        <div className="section__title">Releated Tags</div>
        <ul className="tags-list">
          {tags.map((text) => {
            return (
              <li className="tags-list__item">
                <a className="tags-list__item-link" href="#/">
                  {text}
                </a>
              </li>
            );
      ...
      <hr className="artwork-container__space" />
      <div className="section">
        <div className="section__title other-works-title">
